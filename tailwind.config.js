...
module.exports = {
	content: [
		'./assets/theme/app/**/*.{ts,js}',
		'./assets/theme/core/components/**/*.{ts,js}',
		"./assets/**/*.js",
		"./assets/**/*.css",
		"./templates/**/*.html.twig",
	],
	...
	plugins: [
		require('./assets/theme/core/plugins/plugin'),
		require('./assets/theme/core/plugins/components/theme'),
		require('./assets/theme/core/plugins/components/breakpoints'),
		require('./assets/theme/core/plugins/components/typography'),
		require('./assets/theme/core/plugins/components/menu'),
		require('./assets/theme/core/plugins/components/dropdown'),
		require('./assets/theme/core/plugins/components/accordion'),
		require('./assets/theme/core/plugins/components/input'),
		require('./assets/theme/core/plugins/components/input-group'),
		require('./assets/theme/core/plugins/components/select'),
		require('./assets/theme/core/plugins/components/textarea'),
		require('./assets/theme/core/plugins/components/file-input'),
		require('./assets/theme/core/plugins/components/switch'),
		require('./assets/theme/core/plugins/components/checkbox'),
		require('./assets/theme/core/plugins/components/radio'),
		require('./assets/theme/core/plugins/components/range'),
		require('./assets/theme/core/plugins/components/container'),
		require('./assets/theme/core/plugins/components/image-input'),
		require('./assets/theme/core/plugins/components/modal'),
		require('./assets/theme/core/plugins/components/drawer'),
		require('./assets/theme/core/plugins/components/tooltip'),
		require('./assets/theme/core/plugins/components/popover'),
		require('./assets/theme/core/plugins/components/btn'),
		require('./assets/theme/core/plugins/components/btn-group'),
		require('./assets/theme/core/plugins/components/tabs'),
		require('./assets/theme/core/plugins/components/pagination'),
		require('./assets/theme/core/plugins/components/card'),
		require('./assets/theme/core/plugins/components/table'),
		require('./assets/theme/core/plugins/components/badge'),
		require('./assets/theme/core/plugins/components/rating'),
		require('./assets/theme/core/plugins/components/scrollable'),
		require('./assets/theme/core/plugins/components/progress'),
		require('./assets/theme/core/plugins/components/apexcharts'),
		require('./assets/theme/core/plugins/components/leaflet'),
		iconsPlugin({
